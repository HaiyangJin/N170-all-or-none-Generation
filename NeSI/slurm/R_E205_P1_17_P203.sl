#!/bin/bash
#SBATCH --job-name=32P117     # job name (shows up in the queue)
...
#SBATCH --output=P203/R_E2_P1_17_P203_%j.out # Include the job ID in the names of
...
echo "Executing R ..."
srun Rscript P203/NeSI_lmm_E2_P1_17_P203.R
echo "R finished."
