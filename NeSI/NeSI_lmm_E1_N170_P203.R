...
message("Fitting the lmm.max.N170.E1 model...")

# lmm.max.N170 for mean amplitude
lmm.max.N170.E1 <- lmer(MeanAmp ~ Type * Category * Duration * Hemisphere *  +
...
# Saving lmm.max.N170.E1
message("")
message("Saving the lmm.max.N170.E1")
save(lmm.max.N170.E1, file = "E204_N170_lmm_max.RData")
...
# message("")
# message(paste0(strrep("#", 80)))
# message("Fitting the lmm.zcp.N170.E1 model...")
# 
# # lmm.zcp.N170 for mean amplitude
# lmm.zcp.N170.E1 <- lmer(MeanAmp ~ Type * Category * Duration * Hemisphere *  +
#                           (1 + Type_C + Cate_C + Dura_C + Hemi_C +
#                              Type_Cate + Type_Dura + Cate_Dura + Type_Hemi + Cate_Hemi + Dura_Hemi +
#                              Type_Cate_Dura + Type_Cate_Hemi + Type_Dura_Hemi + Cate_Dura_Hemi +
#                              Type_Cate_Dura_Hemi +
...
#                                               optCtrl = list(maxfun = 1e7)))
# 
# # Saving lmm.zcp.N170.E1
# message("")
# message("Saving the lmm.zcp.N170.E1")
# save(lmm.zcp.N170.E1, file = "E204_N170_lmm_zcp.RData")

#############################  Obtaining (step) the lmm.rdc.N170 for N170  ##############################
# # reduce the lmm.zcp.n170.E1 model
# message("")
# message(paste0(strrep("#", 80)))
# message("Reducing the lmm.zcp.N170.E1 model...")
# 
# load("E204_N170_lmm_zcp.RData")
# lmm.zcp.N170.E1.step <- step(lmm.zcp.N170.E1, reduce.fixed = FALSE)
# 
# # Saving lmm.zcp.N170.step
# message("")
# message("Saving the lmm.zcp.N170.E1.step")
# save(lmm.zcp.N170.E1.step, file = "E204_N170_lmm_zcp_step.RData")
...
# # Saving lmm.rdc.N170
# message("")
# message("Saving the lmm.rdc.N170.E1")
# save(lmm.rdc.N170.E1, file = "E204_N170_lmm_rdc.RData")
...
# lmm.rdc1.N170.E1 <- update(lmm.rdc.N170.E1,
#                           formula = MeanAmp ~ Type * Category * Duration * Hemisphere * ACC +
#                             (1 + Type_D + Cate_D + Dura_D + Hemi_D +
#                                Type_Cate + Type_Dura + Cate_Dura + Type_Hemi + Cate_Hemi + Dura_Hemi + Cate_ACC +
#                                Type_Cate_Dura + Type_Cate_Hemi + Type_Dura_Hemi + Cate_Dura_ACC || SubjCode))
...
# message("")
# message("Saving the lmm.rdc1.N170.E1")
# save(lmm.rdc1.N170.E1, file = "E204_N170_lmm_rdc1.RData")
