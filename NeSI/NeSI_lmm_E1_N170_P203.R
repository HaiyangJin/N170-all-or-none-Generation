...
# lmm.zcp.N170.E1 <- lmer(MeanAmp ~ Type * Category * Duration * Hemisphere * Response +
#                           (1 + Type_C + Cate_C + Dura_C + Hemi_C +
#                              Type_Cate + Type_Dura + Cate_Dura + Type_Hemi + Cate_Hemi + Dura_Hemi +
#                              Type_Cate_Dura + Type_Cate_Hemi + Type_Dura_Hemi + Cate_Dura_Hemi +
#                              Type_Cate_Dura_Hemi +
...
# message("")
# message(paste0(strrep("#", 80)))
# message("Fitting the lmm.rdc.N170.E1 model...")
# 
...
message("")
message(paste0(strrep("#", 80)))
message("Fitting the lmm.etd.N170.E1 model...")
...
# Saving lmm.etd.N170.E1
message("")
message("Saving the lmm.etd.N170.E1")
save(lmm.etd.N170.E1, file = "E204_N170_lmm_rdc.RData")
