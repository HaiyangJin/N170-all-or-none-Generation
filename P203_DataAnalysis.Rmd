...
```{r maximal lmm for E204 N170 E1}
# backup without resp
...
acc.ColuPlot.E2 <- {
  ggplot(data = desc.resp.E2, aes(y = Mean, x = Resp, fill = Category)) +  # set the data, varialbes for x and y axises, and the variable for dividing data
    ...
    coord_cartesian(ylim = c(0,1.1)) +  # set the limit for y axis
    scale_y_continuous(expand= c(0, 0)) +  # remove the space between columns and x axis
    labs(title = "Accuracy for E204", x = "Stimulus Type", y = "Accuracy", fill = "Category") +  # set the names for main, x and y axises
    scale_fill_grey() +  # set the color for columns
    # geom_text(label = c("***", "***", "", ""), color = c("red", "red", "red", "red"), size = 6, nudge_y = 0.05, nudge_x = rep(c(-0.225, 0.225), 2)) + # add starts to the significant columns
    theme_bw() +
    plot_theme
...
# dummy coding
df.erp.E2 <- sdif_coding_P203_erp(df.erp.E2)
```
...
if (saveCSV) {
  output.erp.P1.E2 <- file.path(folder.nesi, "E204_erp_P1.RData")
...
file.max.P1.E2 <- file.path(folder.nesi, "E204_P1_lmm_max.RData")
...
#### The zero-correlation-parameter model
```{r zcp lmm for P1 E2}
file.zcp.P1.E2 <- file.path(folder.nesi, "E204_P1_lmm_zcp.RData")
...
file.rdc.P1.E2 <- file.path(folder.nesi, "E204_P1_lmm_rdc.RData")
...
file.rdc1.P1.E2 <- file.path(folder.nesi, "E204_P1_lmm_rdc1.RData")
...
if (saveCSV) {
  output.erp.N170.E2 <- file.path(folder.nesi, "E204_erp_N170.RData")
...
file.max.N170.E2 <- file.path(folder.nesi, "E204_N170_lmm_max.RData")
...
file.zcp.N170.E2 <- file.path(folder.nesi, "E204_N170_lmm_zcp.RData")
...
file.rdc.N170.E2 <- file.path(folder.nesi, "E204_N170_lmm_rdc.RData")
...
file.rdc1.N170.E2 <- file.path(folder.nesi, "E204_N170_lmm_rdc1.RData")
