...
print(summary(lmm.etd.P1.E2), corr = FALSE)

```

```{r}
summary(rePCA(lmm.etd.P1.E2))
```


```{r }

file.etd1.P1.E2 <- file.path(folder.nesi, "E205_P1_lmm_etd1.RData")

# fit the etd1 model
if (!file.exists(file.etd1.P1.E2)) {
  ...
  load(file.etd1.P1.E2)
}

print(summary(lmm.etd1.P1.E2), corr = FALSE)

```

```{r}
summary(rePCA(lmm.etd1.P1.E2))
```


```{r }

file.etd2.P1.E2 <- file.path(folder.nesi, "E205_P1_lmm_etd2.RData")

# fit the etd2 model
if (!file.exists(file.etd2.P1.E2)) {
  ...
  load(file.etd2.P1.E2)
}

print(summary(lmm.etd2.P1.E2), corr = FALSE)

```

```{r}
summary(rePCA(lmm.etd2.P1.E2))
```


```{r }

file.etd3.P1.E2 <- file.path(folder.nesi, "E205_P1_lmm_etd3.RData")

# fit the etd3 model
if (!file.exists(file.etd3.P1.E2)) {
  ...
  load(file.etd3.P1.E2)
}

print(summary(lmm.etd3.P1.E2), corr = FALSE)

```

```{r}
anova(lmm.etd3.P1.E2, lmm.rdc.P1.E2)
```

##### The optimal model
```{r }

file.opt.P1.E2 <- file.path(folder.nesi, "E205_P1_lmm_opt.RData")

# fit the opt model
if (!file.exists(file.opt.P1.E2)) {
...
```{r}
emm.P1.E2 <- emmeans(lmm.opt.P1.E2,  ~ c(Hemisphere, Duration, Category, Type) )
...
##### Plots
```{r}
emmip(emm.P1.E2, Duration ~ Category | Hemisphere * Type, CIs = TRUE) + 
  facet_grid(Type ~ Hemisphere)
...
contrast(emm.P1.E2, pairwise = "Category")
pairs(emmeans(lmm.opt.P1.E2, "Category"))
```
...
```{r}
summary(rePCA(lmm.etd3.N170.E2))
```


```{r }

file.etd4.N170.E2 <- file.path(folder.nesi, "E205_N170_lmm_etd4.RData")

# fit the etd4 model
if (!file.exists(file.etd4.N170.E2)) {
  ...
  load(file.etd4.N170.E2)
}

print(summary(lmm.etd4.N170.E2), corr = FALSE)

```


```{r}
anova(lmm.etd4.N170.E2, lmm.rdc.N170.E2)
```

##### The optimal model
```{r }

file.opt.N170.E2 <- file.path(folder.nesi, "E205_N170_lmm_opt.RData")

# fit the opt model
if (!file.exists(file.opt.N170.E2)) {

  lmm.opt.N170.E2 <- update(lmm.rdc.N170.E2,
                          REML = TRUE)
  
} else {
  load(file.opt.N170.E2)
}
...
##### Estimated marginal means
```{r}
emm.N170.E2 <- emmeans(lmm.opt.N170.E2,  ~ c(Hemisphere, Duration, Category, Type) )
...
##### Plots
```{r}
emmip(emm.N170.E2, Category * Type ~ Duration | Hemisphere) + 
...
if (saveCSV) {
  ...
  save(df.erp.P1.E2.SC, file = output.erp.P1.E2.SC)
}
