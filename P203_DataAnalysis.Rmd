...
acc.RainPlot.E1 <- {
  ggplot(data = sum.acc.R.E1, aes(y = Accuracy, x = Type, fill = Duration)) + 
...
##### Fit with all optimizers
```{r}
file.max.rt.E1.allFit <- file.path(folder.nesi, "E204_rt_glmm_max_allFit.RData")

if (!file.exists(file.max.rt.E1.allFit)) {
  glmm.max0.rt.E1 <- glmer(RT ~ Type * Category * Duration +
                             (1 + Type_D + Cate_D + Dura_D + Type_Cate + Type_Dura + Cate_Dura + Type_Cate_Dura | SubjCode) +
                             (1 + Dura_D | Stimuli),
                           data = df.rt.E1,
                           family = "poisson")
  
  glmm.max.rt.E1.allFit = allFit(glmm.max0.rt.E1,
                                 maxfun = 1e5,
                                 parallel = "multicore")
} else {
  load(file.max.rt.E1.allFit)
}

print(summary(glmm.max.rt.E1.allFit), corr = FALSE)
...
# dummy coding
df.erp.E1 <- sdif_coding_P203_erp(df.erp.E1)
```
...
if (!file.exists(file.max.P1.E1)) {
  lmm.max.P1.E1 <- lmer(MeanAmp ~ Type * Category * Duration * Hemisphere * ACC + 
...
if (!file.exists(file.zcp.P1.E1)) {
  lmm.zcp.P1.E1 <- update(lmm.max.P1.E1,
  ...
  # lmm.zcp.P1.E1 <- lmer(MeanAmp ~ Type * Category * Duration * Hemisphere * ACC +
  #                         (1 + Type_D + Cate_D + Dura_D + Hemi_D + ACC_D +
  #                            Type_Cate + Type_Dura + Cate_Dura + Type_Hemi + Cate_Hemi + Dura_Hemi + Type_ACC + Cate_ACC + Dura_ACC + Hemi_ACC +
  #                            Type_Cate_Dura + Type_Cate_Hemi + Type_Dura_Hemi + Cate_Dura_Hemi + Type_Cate_ACC + Type_Dura_ACC + Cate_Dura_ACC +
  #                            Type_Hemi_ACC + Cate_Hemi_ACC + Dura_Hemi_ACC +
...
```{r}
anova(lmm.rdc.P1.E1, lmm.rdc1.P1.E1)
```

```{r}
summary(rePCA(lmm.rdc1.P1.E1))
```
...
file1.max.N170.E1 <- file.path(folder.nesi, "E204_N170_lmm_max.RData")

# fit the maximal model
if (!file.exists(file1.max.N170.E1)) {
  lmm1.max.N170.E1 <- lmer(MeanAmp ~ Type * Category * Duration * Hemisphere * urResponse + 
  ...
  load(file1.max.N170.E1)
}

print(summary(lmm1.max.N170.E1), corr = FALSE)
...
if (!file.exists(file.zcp.N170.E1)) {
  lmm.zcp.N170.E1 <- update(lmm.max.N170.E1,
                            formula = MeanAmp ~ Type * Category * Duration * Hemisphere * ACC +
                          (1 + Type_D + Cate_D + Dura_D + Hemi_D + ACC_D +
                             Type_Cate + Type_Dura + Cate_Dura + Type_Hemi + Cate_Hemi + Dura_Hemi + Type_ACC + Cate_ACC + Dura_ACC + Hemi_ACC +
                             Type_Cate_Dura + Type_Cate_Hemi + Type_Dura_Hemi + Cate_Dura_Hemi + Type_Cate_ACC + Type_Dura_ACC + Cate_Dura_ACC +
   ...
   # lmm.zcp.N170.E1 <- lmer(MeanAmp ~ Type * Category * Duration * Hemisphere * ACC +
   #                        (1 + Type_D + Cate_D + Dura_D + Hemi_D + ACC_D +
   #                           Type_Cate + Type_Dura + Cate_Dura + Type_Hemi + Cate_Hemi + Dura_Hemi + Type_ACC + Cate_ACC + Dura_ACC + Hemi_ACC +
   #                           Type_Cate_Dura + Type_Cate_Hemi + Type_Dura_Hemi + Cate_Dura_Hemi + Type_Cate_ACC + Type_Dura_ACC + Cate_Dura_ACC +
   #                           Type_Hemi_ACC + Cate_Hemi_ACC + Dura_Hemi_ACC +
...
anova(lmm.max.N170.E1, lmm.zcp.N170.E1)
```
...
#### Model 3 (intact only)
```{r}
df.erp.N170.E1.intact <- filter(df.erp.N170.E1, Type == "intact")

if (saveCSV) {
  output.erp.N170.E1.intact <- file.path(folder.nesi, "E204_erp_N170_intact.RData")
  save(df.erp.N170.E1.intact, file = output.erp.N170.E1.intact)
}
```
...
file3.max.N170.E1 <- file.path(folder.nesi, "E204_N170_lmm3_max.RData")

# fit the maximal model
if (!file.exists(file3.max.N170.E1)) {
  lmm3.max.N170.E1 <- lmer(MeanAmp ~ Category * Duration * Hemisphere * ACC + 
                        ...
                        data = df.erp.N170.E1.intact,
                        REML = FALSE,
                        # verbose = TRUE,
                        control = lmerControl(optimizer = "Nelder_Mead",  # nloptwrap Nelder_Mead
                                              optCtrl = list(maxfun = 1e7)))
} else {
  load(file3.max.N170.E1)
}

print(summary(lmm3.max.N170.E1), corr = FALSE)
