...
pairs(emm.N170.E2, simple = c("Duration"), adjust = "none")
...
file.max.P1.SC.E2 <- file.path(folder.nesi, "E205_P1_SC_lmm_max.RData")

# fit the maximal model
if (!file.exists(file.max.P1.SC.E2)) {
...
file.zcp.P1.SC.E2 <- file.path(folder.nesi, "E205_P1_SC_lmm_zcp.RData")

# fit the zcp model
if (!file.exists(file.zcp.P1.SC.E2)) {
...
file.rdc.P1.SC.E2 <- file.path(folder.nesi, "E205_P1_SC_lmm_rdc.RData")

# fit the rdc model
if (!file.exists(file.rdc.P1.SC.E2)) {
...
```{r}
summary(rePCA(lmm.rdc.P1.SC.E2))
...
file.rdc1.P1.SC.E2 <- file.path(folder.nesi, "E205_P1_SC_lmm_rdc1.RData")

# fit the rdc1 model
if (!file.exists(file.rdc1.P1.SC.E2)) {
  ...
  load(file.rdc1.P1.SC.E2)
}

print(summary(lmm.rdc1.P1.SC.E2), corr = FALSE)

```

```{r}
summary(rePCA(lmm.rdc1.P1.SC.E2))
```

```{r}

lmm.rdc1.P1.SC.E2.test <- lmer(MeanAmp ~ Category * Hemisphere * DuraConf +
                                 (0 + ConLH_C + ConGL_C + Con2G_C | SubjCode) ,
                               data = df.erp.P1.SC.E2,
                               verbose = TRUE,
                               control = lmerControl(optimizer = "bobyqa",  # nloptwrap Nelder_Mead
                                                     optCtrl = list(maxfun = 1e7)))

summary(lmm.rdc1.P1.SC.E2.test)

summary(rePCA(lmm.rdc1.P1.SC.E2.test))
```



```{r}
anova(lmm.rdc1.P1.SC.E2, lmm.zcp.P1.SC.E2, refit = FALSE)
```
...
file.max.N170.SC.E2 <- file.path(folder.nesi, "E205_N170_SC_lmm_max.RData")

# fit the maximal model
if (!file.exists(file.max.N170.SC.E2)) {
...
file.zcp.N170.SC.E2 <- file.path(folder.nesi, "E205_N170_SC_lmm_zcp.RData")

# fit the zcp model
if (!file.exists(file.zcp.N170.SC.E2)) {
...
# anova(lmm.max.N170.SC.E2, lmm.zcp.N170.SC.E2)
```
...
lmm.zcp.N170.SC.E2.step <- file.path(folder.nesi, "E205_N170_SC_lmm_zcp_step.RData")

# fit the rdc model
if (!file.exists(lmm.zcp.N170.SC.E2.step)) {

  lmm.zcp.N170.SC.E2.step <- step(lmm.zcp.N170.SC.E2, reduce.fixed = FALSE)

  
} else {
  load(lmm.zcp.N170.SC.E2.step)
}

lmm.zcp.N170.SC.E2.step
...
file.rdc.N170.SC.E2 <- file.path(folder.nesi, "E205_N170_SC_lmm_rdc.RData")

# fit the rdc model
if (!file.exists(file.rdc.N170.SC.E2)) {
...
```{r}
summary(rePCA(lmm.rdc.N170.SC.E2))
```


```{r}

file.rdc1.N170.SC.E2 <- file.path(folder.nesi, "E205_N170_SC_lmm_rdc1.RData")

# fit the rdc1 model
if (!file.exists(file.rdc1.N170.SC.E2)) {
  ...
  load(file.rdc1.N170.SC.E2)
}

print(summary(lmm.rdc1.N170.SC.E2), corr = FALSE)

```

```{r}
summary(rePCA(lmm.rdc1.N170.SC.E2))
```
...
file.rdc2.N170.SC.E2 <- file.path(folder.nesi, "E205_N170_SC_lmm_rdc2.RData")

# fit the rdc2 model
if (!file.exists(file.rdc2.N170.SC.E2)) {
  ...
  load(file.rdc2.N170.SC.E2)
}

print(summary(lmm.rdc2.N170.SC.E2), corr = FALSE)

```

```{r}
summary(rePCA(lmm.rdc2.N170.SC.E2))
```
