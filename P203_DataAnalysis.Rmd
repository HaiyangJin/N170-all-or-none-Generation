...
file.max.P1.E4 <- file.path(folder.nesi, "E204_lmm_max_P1.RData")
...
# PCA analysis for zcp model
summary(rePCA(lmm.zcp.P1.E4))

```

The variances of all directions were larger than 1%, therefore no random factors should be removed without considering the correlations. 
We will create extended model directly from maximal model.

#### Extended model
```{r PCA analysis for zcp lmm for E204 P1}
# PCA analysis for zcp model
summary(rePCA(lmm.max.P1.E4))
...
file.max.N170.E4 <- file.path(folder.nesi, "E204_lmm_max_N170.RData")
