...
```{r manually add dummy coding for accuracy (E4)}
sum.acc.R.E4 <- {
  sum.acc.R.E4 %>% 
...
```{r}
lmm.max.acc.E4 <- lmer(Accuracy ~ Type * Duration + (1 + Type_D + Dura_D | SubjCode),
                       data = sum.acc.R.E4,
                       REML = FALSE,
                       control = lmerControl(optimizer = "bobyqa"))

summary(lmm.max.acc.E4)
```
...
summary(lmm.zcp.acc.E4)
```

```{r}
lmm.rdc.acc.E4 <- update(lmm.zcp.acc.E4, 
                         formula = Accuracy ~ Type * Duration + (1 | SubjCode))

summary(lmm.rdc.acc.E4)
```

```{r}
anova(lmm.zcp.acc.E4, lmm.rdc.acc.E4)
```

```{r}
lmm.rdc1.acc.E4 <- update(lmm.zcp.acc.E4,
                          formula = Accuracy ~ Type * Duration + (1 + Type_Dura || SubjCode))

summary(lmm.rdc1.acc.E4)
```

```{r}
anova(lmm.rdc1.acc.E4, lmm.rdc.acc.E4)
```

```{r}
lmm.opt.acc.E4 <- update(lmm.rdc.acc.E4,
                         REML = TRUE)

summary(lmm.opt.acc.E4)
```

```{r}
# qqplot_lmer(lmm.opt.acc.E4)
...
```{r}
emm.acc.E4 <- emmeans(lmm.opt.acc.E4, ~ Duration | Type)

data.frame(emm.acc.E4)
```

```{r}
emmip(lmm.opt.acc.E4, ~ Duration | Type, CIs = TRUE)
```

```{r}
contrast(emm.acc.E4, "pairwise", simple = "each", combine = TRUE)
```

```{r}
test(emm.acc.E4, null = 0.5, side = ">")
...
```{r manually add dummy coding for hit (E4)}
sum.hit.R.E4 %<>% dummy_coding_P203() 
...
```{r}
lmm.max.hit.E4 <- lmer(Hit ~ Type * Category * Duration + 
                         (1 + Type_D + Cate_D + Dura_D + Type_Cate + Type_Dura + Cate_Dura | SubjCode),
                       data = sum.hit.R.E4,
                       REML = FALSE,
                       control = lmerControl(optimizer = "bobyqa"))

summary(lmm.max.hit.E4)
```

```{r}
lmm.zcp.hit.E4 <- update(lmm.max.hit.E4,
                         formula = Hit ~ Type * Category * Duration + 
                         (1 + Type_D + Cate_D + Dura_D + Type_Cate + Type_Dura + Cate_Dura || SubjCode))

summary(lmm.zcp.hit.E4)
```

```{r}
summary(rePCA(lmm.zcp.hit.E4))

lmm.rdc.hit.E4 <- update(lmm.zcp.hit.E4,
                         formula = Hit ~ Type * Category * Duration + 
                         (0 + Cate_D + Type_Cate || SubjCode))

anova(lmm.rdc.hit.E4, lmm.zcp.hit.E4)

```

```{r}
lmm.rdc1.hit.E4 <- update(lmm.rdc.hit.E4, 
                          formula = Hit ~ Type * Category * Duration + 
                         (0 + Cate_D + Type_Cate + Type_Cate_Dura || SubjCode))

anova(lmm.rdc1.hit.E4, lmm.rdc.hit.E4)
```

```{r}
lmm.etd.hit.E4 <- update(lmm.rdc.hit.E4,
                         formula = Hit ~ Type * Category * Duration + 
                         (0 + Cate_D + Type_Cate | SubjCode))

summary(lmm.etd.hit.E4)
```

```{r}
lmm.etd1.hit.E4 <- update(lmm.rdc.hit.E4,
                         formula = Hit ~ Type * Category * Duration + 
                         (0 + Cate_D | SubjCode))

summary(lmm.etd1.hit.E4)
```

```{r}
lmm.etd2.hit.E4 <- update(lmm.rdc.hit.E4,
                         formula = Hit ~ Type * Category * Duration + 
                         (0 + Type_Cate | SubjCode))

summary(lmm.etd2.hit.E4)
```

```{r}
anova(lmm.etd1.hit.E4, lmm.etd2.hit.E4)
```

```{r}
lmm.opt.hit.E4 <- update(lmm.etd2.hit.E4,
                         REML = TRUE)

summary(lmm.opt.hit.E4)
```

```{r}
emm.hit.E4 <- emmeans(lmm.opt.hit.E4, ~ c(Category, Duration) | Type)

data.frame(emm.hit.E4)
```

```{r}
emmip(lmm.opt.hit.E4, Category ~ Duration | Type, CIs = TRUE)
```

```{r}
contrast(emm.hit.E4, "pairwise", simple = "each", combine = TRUE)
```

```{r}
test(emm.hit.E4, null = 0.5, side = "two-sided")
```
...
file.max.resp.E4 <- file.path(folder.nesi, "E204_resp_glmm_max.RData")

if (!file.exists(file.max.resp.E4)) {
  ...
  load(file.max.resp.E4)
}

print(summary(glmm.max.resp.E4), corr = FALSE)

```

```{r}
summary(rePCA(glmm.max.resp.E4))
```


##### The zero-correlation-parameter model
```{r zcp lmm for E204 Response}
file.zcp.resp.E4 <- file.path(folder.nesi, "E204_resp_glmm_zcp.RData")

if (!file.exists(file.zcp.resp.E4)) {
  ...
  load(file.zcp.resp.E4)
}

print(summary(glmm.zcp.resp.E4), corr = FALSE)

```

```{r}
print(summary(glmm.zcp1.resp.E4), corr = FALSE)
...
##### The reduced model
```{r}
summary(rePCA(glmm.zcp1.resp.E4))

```

##### Fit with all optimizers
```{r}
file.max.resp.E4.allFit <- file.path(folder.nesi, "E204_resp_glmm_max_allFit.RData")

if (!file.exists(file.max.resp.E4.allFit)) {
  glmm.max0.resp.E4 <- glmer(resp ~ Type * Category * Duration +
                             (1 + Type_D + Cate_D + Dura_D + Type_Cate + Type_Dura + Cate_Dura + Type_Cate_Dura | SubjCode) +
                             (1 + Dura_D | Stimuli),
                           data = clean.beha.E4,
                           family = "binomial")
  ...
  load(file.max.resp.E4.allFit)
}

print(summary(glmm.max.resp.E4.allFit), corr = FALSE)
...
if (!file.exists(file.rdc.rt.E4)) {
  lmm.rdc.rt.E4 <- step(lmm.zcp.rt.E4, reduce.fixed = FALSE)
...
```{r}
anova(lmm.zcp.rt.E4, lmm.rdc.rt.E4)
```
...
file.opt.rt.E4 <- file.path(folder.nesi, "E204_rt_lmm_opt.RData")

if (!file.exists(file.opt.rt.E4)) {
...
print(summary(lmm.opt.rt.E4), corr = FALSE)
...
```{r}
file.max1.rt.E4 <- file.path(folder.nesi, "E204_rt_glmm_max1.RData")

if (!file.exists(file.max1.rt.E4)) {
  glmm.max1.rt.E4 <- refit(glmm.max.rt.E4)
} else {
  load(file.max1.rt.E4)
}

print(summary(glmm.max1.rt.E4), corr = FALSE)

```

##### Fit with all optimizers
```{r}
file.max.rt.E4.allFit <- file.path(folder.nesi, "E204_rt_glmm_max_allFit.RData")

if (!file.exists(file.max.rt.E4.allFit)) {
  ...
  load(file.max.rt.E4.allFit)
}

print(summary(glmm.max.rt.E4.allFit), corr = FALSE)
...
#### Build up 
```{r}
file.P1.E4.1 <- file.path(folder.nesi, "E204_P1_lmm_1.RData")

# fit the maximal model
if (!file.exists(file.P1.E4.1)) {
...
```{r}
summary(rePCA(lmm.P1.E4.1))
```



```{r}
file.P1.E4.2 <- file.path(folder.nesi, "E204_P1_lmm_2.RData")

# fit the maximal model
if (!file.exists(file.P1.E4.2)) {
...
print(summary(lmm.P1.E4.2), corr = FALSE)
```

```{r}
summary(rePCA(lmm.P1.E4.2))
```



```{r}
file.P1.E4.3 <- file.path(folder.nesi, "E204_P1_lmm_1.RData")

# fit the maximal model
if (!file.exists(file.P1.E4.3)) {
...
print(summary(lmm.P1.E4.3), corr = FALSE)
```
...
summary(rePCA(lmm.zcp.P1.E4))
```


```{r }

file.rdc.P1.E4 <- file.path(folder.nesi, "E204_P1_lmm_rdc.RData")

# fit the rdc model
if (!file.exists(file.rdc.P1.E4)) {
  # lmm.rdc.P1.E4.step <- step(lmm.rdc.P1.E4, reduce.fixed = FALSE)
...
```{r}
anova(lmm.rdc.P1.E4, lmm.zcp.P1.E4)
```


```{r}
summary(rePCA(lmm.rdc.P1.E4))
```


```{r}

file.rdc1.P1.E4 <- file.path(folder.nesi, "E204_P1_lmm_rdc1.RData")

# fit the rdc1 model
if (!file.exists(file.rdc1.P1.E4)) {
  # lmm.rdc1.P1.E4.step <- step(lmm.rdc1.P1.E4, reduce.fixed = FALSE)
  ...
  load(file.rdc1.P1.E4)
}

print(summary(lmm.rdc1.P1.E4), corr = FALSE)
```


```{r}
anova(lmm.rdc.P1.E4, lmm.rdc1.P1.E4)
```

```{r}
summary(rePCA(lmm.rdc1.P1.E4))
```
...
print(summary(lmm0.int.N170.E4), corr = FALSE)

```

```{r}
# random intercept and the correspondin random slopes
file1.slp.N170.E4 <- file.path(folder.nesi, "E204_N170_lmm0_slp.RData")

if (!file.exists(file1.slp.N170.E4)) {
  lmm0.slp.N170.E4 <- lmer(MeanAmp ~ Type * Category * Duration * Hemisphere + 
  ...
  load(file1.slp.N170.E4)
}

print(summary(lmm0.slp.N170.E4), corr = FALSE)

```

```{r}
# lmm0.slp.N170.E4.step <- step(lmm0.slp.N170.E4, reduce.fixed = FALSE)
# 
# lmm0.rdc.N170.E4 <- get_model(lmm0.slp.N170.E4.step)
# 
# summary(rePCA(lmm0.slp.N170.E4))
```


```{r}
# random intercept and the correspondin random slopes
file1.etd.N170.E4 <- file.path(folder.nesi, "E204_N170_lmm0_etd.RData")

if (!file.exists(file1.etd.N170.E4)) {
  ...
  load(file1.etd.N170.E4)
}

print(summary(lmm0.etd.N170.E4), corr = FALSE)
```
...
lmm00.int.N170.E4 <- lmer(MeanAmp ~ Type * Category * Duration * Hemisphere * ACC + 
                           (1 | SubjCode),
                         data = df.erp.N170.E4,
                         REML = FALSE,
                         # verbose = TRUE,
...
print(summary(lmm00.int.N170.E4), corr = FALSE)

```


```{r}
lmm00.slp.N170.E4 <- lmer(MeanAmp ~ Type * Category * Duration * Hemisphere * ACC + 
                            (1 + Type_D + Cate_D + Dura_D + Hemi_D + ACC_D + 
                               Type_Cate + Type_Dura + Type_Hemi + Cate_Hemi + Dura_Hemi + Type_ACC + Cate_ACC + 
                               Type_Cate_ACC + Cate_Dura_ACC || SubjCode),
                          data = df.erp.N170.E4,
                          REML = FALSE,
                          # verbose = TRUE,
                          control = lmerControl(optimizer = "bobyqa",  # nloptwrap Nelder_Mead
...
print(summary(lmm00.slp.N170.E4), corr = FALSE)
```


```{r}
summary(rePCA(lmm00.slp.N170.E4))
```
...
file1.max.N170.E4 <- file.path(folder.nesi, "E204_N170_lmm_max.RData")

# fit the maximal model
if (!file.exists(file1.max.N170.E4)) {
  ...
  load(file1.max.N170.E4)
}

print(summary(lmm1.max.N170.E4), corr = FALSE)
...
summary(rePCA(lmm.zcp.N170.E4))
```


```{r}

file.rdc.N170.E4 <- file.path(folder.nesi, "E204_N170_lmm_rdc.RData")

# fit the rdc model
if (!file.exists(file.rdc.N170.E4)) {
  # lmm.rdc.N170.E4.step <- step(lmm.rdc.N170.E4, reduce.fixed = FALSE)
  
  lmm.rdc.N170.E4 <- update(lmm.rdc.N170.E4,
                          formula = MeanAmp ~ Type * Category * Duration * Hemisphere * ACC +
                          (1 + Type_D + Cate_D + Dura_D + Hemi_D + 
...
```{r}
anova(lmm.rdc.N170.E4, lmm.zcp.N170.E4)
```
...
file.rdc1.N170.E4 <- file.path(folder.nesi, "E204_N170_lmm_rdc1.RData")

# fit the rdc1 model
if (!file.exists(file.rdc1.N170.E4)) {
  # lmm.rdc1.N170.E4.step <- step(lmm.rdc1.N170.E4, reduce.fixed = FALSE)
  
  lmm.rdc1.N170.E4 <- update(lmm.rdc1.N170.E4,
                          formula = MeanAmp ~ Type * Category * Duration * Hemisphere * ACC +
                          (1 + Type_D + Cate_D + Dura_D + Hemi_D + ACC_D +
                             Type_Cate + Type_Dura + Cate_Dura + Type_Hemi + Cate_Hemi + Dura_Hemi + Type_ACC + Cate_ACC + Dura_ACC + Hemi_ACC +
  ...
  load(file.rdc1.N170.E4)
}

print(summary(lmm.rdc1.N170.E4), corr = FALSE)
...
#### Model 3 (intact only)
```{r}
df.erp.N170.E4.intact <- filter(df.erp.N170.E4, Type == "intact")

if (saveCSV) {
  output.erp.N170.E4.intact <- file.path(folder.nesi, "E204_erp_N170_intact.RData")
  save(df.erp.N170.E4.intact, file = output.erp.N170.E4.intact)
}
```
...
#### The maximal model
```{r maximal lmm3 for E204 N170}
file3.max.N170.E4 <- file.path(folder.nesi, "E204_N170_lmm3_max.RData")

# fit the maximal model
if (!file.exists(file3.max.N170.E4)) {
  ...
  load(file3.max.N170.E4)
}

print(summary(lmm3.max.N170.E4), corr = FALSE)
