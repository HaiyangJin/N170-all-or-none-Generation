...
plot.hypo <- ggarrange(plot.lit, plot.st, widths = c(1.1, 4))

# ggsave('plot_hypo.png', plot.hypo, width = 7, height = 3)
...
resp.stim <- {
  ...
  # %>% 
  #   group_by(Stimuli, Duration, Resp, Type, Category) %>%
  #   summarize(avgCount = sum(Count)/28/8)
}
